public class Main {
    public static void main(String[] args) {
        ...
        Matrix<Double> myMatrixSecond = new Matrix<Double>(2, 2);
        ...
        Matrix<Double> myMatrixThird = new Matrix<Double>(4, 4);
        ...
        System.out.println("\naction + " + new ComplexNum(1, 2).toString());
        ...
        Matrix<ComplexNum> myMatrixComplex2 = new Matrix<ComplexNum>(2, 2);
        ...
        Matrix<ComplexNum> myMatrixComplex3 = new Matrix<ComplexNum>(4, 4);
